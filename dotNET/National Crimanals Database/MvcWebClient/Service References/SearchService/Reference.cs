...
namespace MvcWebClient.SearchService {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="SearchService.INcSearchService")]
    public interface INcSearchService {
        ...
        bool Search(MvcWebClient.SearchService.SearchParameter request, string email, int maxResultCount);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/INcSearchService/Search", ReplyAction="http://tempuri.org/INcSearchService/SearchResponse")]
        System.Threading.Tasks.Task<bool> SearchAsync(MvcWebClient.SearchService.SearchParameter request, string email, int maxResultCount);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface INcSearchServiceChannel : MvcWebClient.SearchService.INcSearchService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class NcSearchServiceClient : System.ServiceModel.ClientBase<MvcWebClient.SearchService.INcSearchService>, MvcWebClient.SearchService.INcSearchService {
        ...
        public bool Search(MvcWebClient.SearchService.SearchParameter request, string email, int maxResultCount) {
            return base.Channel.Search(request, email, maxResultCount);
        }
        
        public System.Threading.Tasks.Task<bool> SearchAsync(MvcWebClient.SearchService.SearchParameter request, string email, int maxResultCount) {
